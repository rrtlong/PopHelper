...
public class CommonDialogWithoutTitle extends BaseDialog<CommonDialogWithoutTitle> {
    ...
    public View onCreateView() {
        ...
        rootView = View.inflate(mContext, R.layout.dialog_common_without_title_layout, null);
    ...
    View.OnClickListener mButtonHandler = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            // executed
            mHandler.obtainMessage(ButtonHandler.MSG_DISMISS_DIALOG, CommonDialogWithoutTitle.this).sendToTarget();
        }
    };
    ...
    public static void showConfirm(Context context, String message, String okButtonText, String cancelButtonText, final DialogCallback dialogCallback) {
        showConfirm(context, message, okButtonText, cancelButtonText, false, dialogCallback, null);
    }

    public static void showConfirm(Context context, String message, String okButtonText, String cancelButtonText, boolean fromTop,
                                   final DialogCallback dialogCallback, final DialogInterface.OnDismissListener onDismissListener) {


        CommonDialogWithoutTitle dialog = new CommonDialogWithoutTitle(context);
