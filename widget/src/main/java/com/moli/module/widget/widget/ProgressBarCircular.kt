 ...
 */
class ProgressBarCircular : View {
    ...
    private fun parseAttributes(a: TypedArray) {
        ...
        circleRadius = a.getDimension(R.styleable.ProgressBarCircular_matProg_circleRadius, circleRadius.toFloat()).toInt()

        fillRadius = a.getBoolean(R.styleable.ProgressBarCircular_matProg_fillRadius, false)

        barWidth = a.getDimension(R.styleable.ProgressBarCircular_matProg_barWidth, barWidth.toFloat()).toInt()

        rimWidth = a.getDimension(R.styleable.ProgressBarCircular_matProg_rimWidth, rimWidth.toFloat()).toInt()

        val baseSpinSpeed = a.getFloat(R.styleable.ProgressBarCircular_matProg_spinSpeed, spinSpeed / 360.0f)
        spinSpeed = baseSpinSpeed * 360

        barSpinCycleTime = a.getInt(R.styleable.ProgressBarCircular_matProg_barSpinCycleTime, barSpinCycleTime.toInt()).toDouble()
